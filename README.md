...
[![Ruby Gem](https://img.shields.io/gem/v/jekyll-bloomz)](https://rubygems.org/gems/jekyll-bloomz)

<p align="center">
  <img src="./_includes/logos/jekyll.png" width="150" height="150"/>
  <img src="./_includes/logos/bloomz.svg" width="150" height="150"/>
</p>

A [Jekyll template](https://github.com/jekyll/minima) with [WikiBonsai](https://github.com/wikibonsai/wikibonsai) support.

You can see the live demo [here](https://jekyll-bloomz.netlify.app/).

🌸 Share bloomz from your [🎋 WikiBonsai](https://github.com/wikibonsai/wikibonsai) digital garden.

---

## WikiBonsai Specific Features

- [[[WikiRefs]]](https://jekyll-bloomz.netlify.app/entry/wikirefs/) support.
- [A semantic tree](https://jekyll-bloomz.netlify.app/entry/semantic-tree/) support.
